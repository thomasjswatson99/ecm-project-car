...
void Interrupts_colorclick_init(void)
{
    ...
    unsigned int threshold = 890;
    char threshLow = (char)(threshold&0b11111111);
    char threshHigh = (char)((threshold-threshLow)>>8);
    color_writetoaddr(0x06,threshLow);
    color_writetoaddr(0x07,threshHigh);



    color_writetoaddr(0x0C,0b1);
    color_writetoaddr(0x00,0b00011011);
